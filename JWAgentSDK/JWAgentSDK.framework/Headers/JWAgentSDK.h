...
//! Project version number for JWAgentSDK.
FOUNDATION_EXPORT double JWAgentSDKVersionNumber;

//! Project version string for JWAgentSDK.
FOUNDATION_EXPORT const unsigned char JWAgentSDKVersionString[];
